...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x14rpc_login_user.proto\x1a\x15rpc_create_user.proto2\x87\x01\n" +
	"\n" +
	"SimpleBank\x12=\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"\x00\x12:\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"\x00B'Z%github.com/alaminpu1007/simplebank/pbb\x06proto3"
